    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 p-6 text-zinc-100">
      <div className="w-full max-w-md rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8 shadow-2xl backdrop-blur-xl">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-zinc-400">Enter your credentials to continue learning</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-zinc-400">
          ...
          <Link href="/auth/register" className="font-medium text-indigo-400 hover:text-indigo-300 hover:underline">
            Register for free
          </Link>
        </p>
      </div>
